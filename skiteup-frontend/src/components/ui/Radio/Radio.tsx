          ...
          `
              ...
              `}
                        >
                            ...
                            <div
                                className="h-[10px] w-[10px] rounded-full bg-[#273469] scale-0 transition-transform duration-150 peer-checked:scale-100 [input:checked~div_&]:scale-100"
                                aria-hidden="true"
                            />
                        </div>
                    </div>
                ...
                [input:checked~span]:text-[#0B3A60]
